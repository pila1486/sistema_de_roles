...
public class EdicionUsuarios extends javax.swing.JFrame {
    ...
    public EdicionUsuarios(Controladora controladora, int idUsuario) {
        initComponents();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        controladora.editarUsuario(usuario, nombreUsuario, contrasena, rol);
        
        
        mostrarMensaje("Usuario edditado correctamente", "info", "Edición exitosa");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        //Marcar - seleccionar el rol que tienen este usuario
